...
tags:
  - Belle and Sebastian
  - Wrapped Up in Books
description: Wrapped Up In Books came into my life during grad school over 20 years ago and I've loved it ever since without ever asking why. Turns out the answer involves an unexpected instrumental break,, and why that lyric is the one I actually remember.
---
...
<figure>
  ...
  <figcaption style={{ textAlign: "center" }}>
    Did someone say Tigermilk? Taken at Oregon Zoo where we saw Belle &
    Sebastian live in 2018
  </figcaption>
</figure>
...
_Wrapped Up in Books_ has been motoring along for over a minute — drums locked in, bass steady, rhythm guitar pushing forward with the kind of relentless momentum that makes you feel like Belle and Sebastian is in their krautrock phase. And then, without any real warning, it all falls away. The drums drop out. The rhythm disappears. And in the space where all that forward drive used to be, a piano appears, and horns enter playing a melodic figure: _dooo do do dooo dooo_. The song seems to have stopped moving. It's floating there, that little horn melody turning over and over on top of melancholic piano and bass.
...
Then the drums come back in, the engine restarts, and eight bars later Stuart Murdoch sings: _Our aspirations are wrapped up in books._
...
This dynamic — how a song is structured, why I want to keep listening, why I'll come back to it again — is why I started this blog and what I want to understand. Not just that it works, but _how_ it works, and what I might take from it as a songwriter.
...
The line _our aspirations are wrapped up in books_ is not doing the heavy lifting on its own. If that lyric appeared in the first verse, with the rhythm section driving underneath it and nothing to distinguish it from the bars on either side, it would register and move on. But arriving where it does — after the drop, after the float, after the return of the engine — it carries the weight of everything that preceded it.
